  ...
  <body>
    <div class="d-flex">
      <div id="sidebar-container" class ="bg-primary">
        ...
        <div class="menu">        
            <a href="dash.html" class="d-block text-light p-3"><i class="icon ion-md-cloudy mr-2 lead"></i>Medicion</a>
            <a href="graficos.php" class="d-block text-light p-3"><i class="icon ion-md-contact mr-2 lead"></i>Graficos</a>
      ...
      <!--Buscador -->
        ...
        <form class="form-inline my-2 my-lg-0" methods="post" names="formFechas" id="formFechas">
        
            <input class="form-control mr-sm-2" type="date" name="start_date" id="start_date" >
            <input class="form-control mr-sm-2 " type="date" name="end_date" id="end_date">
    ...
    <div id="content ">
            ...
            //Ambos vienen del form que tiene como metodo "post"
            $consulta2 = "SELECT * FROM estacion WHERE Fecha BETWEEN '$fechaS' AND '$fechaE'"; //la consulta que hace en un rango de fechas(las que ingrese el usario)
            $ejecutarConsulta2 = mysqli_query($enlace, $consulta2); //el que se cerciora de ejecutar la consulta
						$verFilas2 = mysqli_num_rows($ejecutarConsulta2); //ver las filas de la consulta 2
            $fila2 = mysqli_fetch_array($ejecutarConsulta2); //un arreglo que almacena cada fila
